...
class ConfigFile:
    ...
    def read(self, into, config_path):
        ...
        into.blockUploadWhileTethering, didUpdate = self.read_config_entry(
            ...
            prev_file_contents,
            section=main_section,
            entry="block_upload_while_tethering",
            entry_type=bool,
            default_value=False,
        ...
        into.roadCameraID, didUpdate = self.read_config_entry(
            ...
            configr,
            prev_file_contents,
            section=jetson_section,
            entry="jetson_road_camera_id",
            entry_type=str,
        ...
        into.driverCameraFlip, didUpdate = self.read_config_entry(
            ...
            prev_file_contents,
            section=jetson_section,
            entry="jetson_driver_camera_flip",
            entry_type=int,
            default_value=0,
        ...
        into.monitorForcedRes, didUpdate = self.read_config_entry(
            ...
            prev_file_contents,
            section=jetson_section,
            entry="jetson_monitor_forced_resolution",
            entry_type=str,
        ...
        into.shouldLogProcessCommErrors, didUpdate = self.read_config_entry(
            ...
            prev_file_contents,
            section=logging_section,
            entry="should_log_process_comm_errors",
            entry_type=bool,
            default_value=False,
